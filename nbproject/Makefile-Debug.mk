...
${OBJECTDIR}/src/ClientSocket.o: src/ClientSocket.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -Isrc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ClientSocket.o src/ClientSocket.cpp

${OBJECTDIR}/src/ServerSocket.o: src/ServerSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -Isrc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ServerSocket.o src/ServerSocket.cpp

${OBJECTDIR}/src/Socket.o: src/Socket.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -Isrc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Socket.o src/Socket.cpp

${OBJECTDIR}/src/cNet.o: src/cNet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -Isrc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cNet.o src/cNet.cpp

${OBJECTDIR}/src/cObject.o: src/cObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -Isrc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cObject.o src/cObject.cpp

${OBJECTDIR}/src/cUnits.o: src/cUnits.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -Isrc -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cUnits.o src/cUnits.cpp

${OBJECTDIR}/src/threads.o: src/threads.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -g -Iinclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/threads.o src/threads.c
